...
var _PatternReader = require("./PatternReader");
...
var LoomAction = function () {
  ...
  _createClass(LoomAction, null, [{
    ...
    value: function run() {
      console.clear();
      var pattern = _core["default"].getInput('pattern');
      var bpPath = _core["default"].getInput('behavior_pack_path');
      var rpPath = _core["default"].getInput('resource_pack_path');
      this.reader = new _PatternReader.PatternReader(pattern);
    ...
    value: function shouldFail() {
      if (this.reader.invalid.length > 0) {
        _core["default"].setFailed('TEST: Invalid file endings');
      }
    }
  }]);
  return LoomAction;
...
_defineProperty(LoomAction, "reader", void 0);
